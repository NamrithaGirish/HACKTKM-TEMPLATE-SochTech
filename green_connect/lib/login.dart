          ...
          Expanded(
            child: Column(
              ...
              Container(
                ...
                ElevatedButton(
                  style: ButtonStyle(
                    backgroundColor: MaterialStatePropertyAll(Colors.lightGreen[200])
                  ),
                  onPressed: (){if (selectedOption == 'guidance') {
...
class ButtonSection extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          GestureDetector(
            ...
            child: _buildButtonColumn(context, Icons.people, 'I\'m looking for guidance', selectedOption == 'guidance'),
          ),
          GestureDetector(
            onTap: () {
              onOptionSelected('mentor');
            },
            child: _buildButtonColumn(context, Icons.laptop, 'I want to be a mentor', selectedOption == 'mentor'),
          ),
        ],
      ),
    );
  ...
  Widget _buildButtonColumn(BuildContext context, IconData icon, String label, bool isSelected) {
    return Container(
      width: 200,
      height: 100,
